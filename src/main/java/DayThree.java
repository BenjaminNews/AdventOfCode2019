...
public class DayThree {
    ...
    private int moveWirePartTwo(String[] wireSteps, int endX, int endY) {
        int wireXPosition = 0;
    ...
    private List<String> moveWire(String[] wireSteps) {
        int wireXPosition = 0;
        int wireYPoisition = 0;
